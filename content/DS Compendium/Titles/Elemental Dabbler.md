...
Choose a damage type to which the defeated monster had an immunity (such as fire). Then choose one of the following benefits: • Elemental Blaster: You gain the Elementalist 1st-level Hurl Element feature, dealing the chosen damage type. 
