...
traits:
  - name: "Rivalry The tactician selects one creature within [[Line of Effect]] at the start of an encounter. Both the tactician and the creature can add a 1d3 to all power rolls made against each other."
